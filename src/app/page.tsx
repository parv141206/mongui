      ...
      <div className="relative overflow-hidden bg-black text-white">
        <div className="relative z-10 mx-auto flex flex-col gap-10 p-10 md:container">
          ...
          <section
            ...
            ref={containerRef}
            className="safari-container relative my-16 flex h-fit w-full flex-col items-center justify-center md:flex-row"
          >
            <section
              ref={textRef}
              className="stext absolute left-0 mt-32 flex h-fit w-fit flex-col items-start text-white"
            >
              <div className="huge-code-text text-white/15">SKETCH</div>
              <h1 className="text-left text-3xl text-white">
                Tired of writing Mongoose...
              </h1>
              <div className="border-s-4 border-s-white/15 p-3 text-left text-xl">
            ...
            >
              <Safari
                url="mongui.vercel.app"
                className="size-full"
                imageSrc="/assets/newMockup.png"
              />
            </div>
          </section>
